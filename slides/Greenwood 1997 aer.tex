...
\begin{frame}{现实背景}
    ...
    \begin{column}{0.42\linewidth}
      ...
      \begin{enumerate}
        \item 二战后的黄金增长（1945--1973）
              \begin{itemize}
                \item TFP 年均增速达 2\%，贡献超过 50\%。
              \end{itemize}
        \item 此后，增速全面下滑（1973-1995）
              \begin{itemize}
                \item 1965--1973 为 1.5\%，1973--1995 为 0.6\%。
              \end{itemize}
        \item 同时，技术蓬勃发展
              \begin{itemize}
                \item
  ...
  \end{columns}
  \begin{block}{}
    Solow paradox: You can see the computer everywhere but in the productivity statistics.
  \end{block}
\end{frame}
...
\begin{frame}{模型设定：为什么要和为什么能？}
  \begin{block}{为什么要？}
    ...
    \begin{itemize}
      \item 设备的相对价格下降：
            $$r_{e,t} \downarrow = \dfrac{p^c_t}{q \uparrow}$$
      \item 设备的相对占比提高：
...
\begin{frame}{Figure 3：两种技术进步}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.55\linewidth}
      \paperfig{0.98}{fig3_technological_change.jpg}{Technological Change}
      \footnotesize
      \vspace{-1em}
      注：左轴：资本偏向型技术（$q$），右轴：中性技术（$z$）
    \end{column}
    \begin{column}{0.41\linewidth}
      ...
      \begin{enumerate}
        ...
        \item 经济解读
              \begin{itemize}
                \item 二战后（1945），美国主要的技术进步来自于投资品技术进步。
                \item
              \end{itemize}
      \end{enumerate}
